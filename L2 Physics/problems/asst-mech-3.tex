...
\begin{questions}
  ...
  \question Two children, of masses \SI{50}{\kilo\gram} and \SI{55}{\kilo\gram}, sit opposite each other on a see-saw so that it is exactly
    ...
    \begin{parts}
      ...
      \part The lighter child is sitting right at the end of the see-saw, and the heavier child is sitting \SI{0.7}{\metre} from
            the pivot. What is the length of the see-saw?
