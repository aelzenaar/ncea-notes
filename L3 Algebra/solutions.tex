...
\begin{enumerate}
  ...
  \harder If $ S $ is a set of finitely many complex numbers $ z_1, ..., z_n $, the \emph{convex hull} of $ S $ is the smallest convex set containing
          every point of $ S $. Show that a point $ w $ is in the convex hull of $ S $ precisely when there exist $ n $ real numbers, $ \lambda_1, ..., \lambda_n $,
          such that $ \lambda_1 + \cdots + \lambda_n = 1 $ and
          \begin{displaymath}
  ...
  \hard The following inequality, which holds for all real numbers $ a_1 $, $ a_2 $, ..., $ a_n $, $ b_1 $, ..., $ b_n $, is known as the Cauchy-Schwarz
        ...
        \end{enumerate}
  \hard Multiplication by $ i $ rotates a point by $ \frac{\pi}{2} $ around the origin.
        \begin{enumerate}
          ...
          \item A pirate named Kim Dotcom has hidden his sick tunes on a desert island tax haven in order to evade
