  ...
  \question Part of the course for an ocean swim runs from bouy $ A $ to bouy $ B $. Swimmers must come ashore
            ...
            \begin{center}
              \begin{tikzpicture}[scale=0.6]
                \fill[Dandelion] (-5,0)--(5,0)--(5,-3)--(-5,-3)--cycle;
                \node[label=left:{$B$},circle,fill,inner sep=2pt] at (-4, 2) {};
                \node[label=right:{$A$},circle,fill,inner sep=2pt] at (4, 5) {};
                \node[label=below:{$P$},circle,fill,inner sep=2pt] at (-1, 0) {};
                \draw (-4, -1) --node[below]{\SI{1200}{\metre}} (4, -1);
                \draw (-4, 0) --node[left]{\SI{600}{\metre}} (-4, 2);
                \draw (4, 0) --node[right]{\SI{800}{\metre}} (4, 5);
                \draw[style=dotted] (-4,2)--(-1,0)--(4,5);
              \end{tikzpicture}
            \end{center}
