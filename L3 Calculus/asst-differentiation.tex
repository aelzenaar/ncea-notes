...
\begin{questions}
  ...
  \question
    \begin{parts}
      ...
      \part[3] Show that $ \lim_{x \to 0} \ln x $ does not exist, by assuming that $ \lim_{x \to 0} \ln x = L $ and then showing that
            there exists some $ \delta > 0 $ such that if $ x < \delta $ then $ \ln x < L $.
