...
\textbf{\color{red} The degree of $ p $ must be less than the degree of $ q $, so you may need to
...
\begin{questions}
  ...
  \questioS Evaluate, using partial fractions:
    \begin{parts}
      \part $ \rint \dfrac{3x - 1}{(x - 3)(x + 4)} $
      \part $ \rint \dfrac{1}{x^2 - 3x - 4} $
      \part $ \rint \dfrac{1}{x^2 - 6x - 7} $
      \part $ \rint \dfrac{11x + 17}{2x^2 +7x - 4} $
      \part $ \rint \dfrac{5x - 10}{x^2 - 3x - 4} $
      \part $ \rint \dfrac{x + 7}{x^2 - x - 6} $
      \part $ \rint \dfrac{1}{x^2 + 5x + 6} $
      \part $ \rint \dfrac{2x^2 + 3}{x(x-1)^2} $
    \end{parts}
  ...
  \questioS Use appropriate substitutions to evaluate:
    \begin{parts}
      \part $ \rint \dfrac{\cos \theta}{\sin^2 \theta + 4 \sin \theta - 5} \dif{\theta} $
      \part $ \rint \dfrac{e^{3x}}{e^{2x} + 4} \dif{t} $
      \part $ \rint \dfrac{5 + 2\ln x}{x(1 + \ln x)^2} $
    \end{parts}
  \questioE Don't use a sledgehammer to kill a fly, and compute the following:
    \begin{parts}
      \part $ \rint \dfrac{x^2(5x^2 + 4x - 3)}{x^5 + x^4 - x^3 + 1} \dif{x} $`
      \part $ \rint \dfrac{x^2 + 1}{x(x^2 + 3)} \dif{x} $
    \end{parts}
