...
\filbreak\begin{enumerate}[resume]
  \answer Multiplication by $ i $ rotates a point by $ \frac{\pi}{2} $ around the origin.
        \begin{enumerate}
          ...
          \answerb A pirate named Kim Dotcom has hidden his sick tunes on a desert island tax haven in order to evade
                ...
                using the geometry of complex numbers and rid New Zealand of Kim Dotcom forever.\footnote{~Problem taken from \cite{Kes09}, section 5.1.}
          \end{enumerate}
\end{enumerate}
