...
\begin{exercise}
  ...
  \begin{enumerate}
    ...
    \item Conclude that
          ...
          \end{displaymath}
          (This formula is attributed to Hero of Alexandria.)
  \end{enumerate}
\end{exercise}
...
\begin{itemize}
  \item Marcel Berget, \emph{Geometry I} (trans. by M. Cole and S. Levy). Springer-Verlag (1994).\footnote{Particularly chapter 10.}
