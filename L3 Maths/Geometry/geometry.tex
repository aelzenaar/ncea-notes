...
\begin{titlepage}
  \maketitle
  \begin{center}
  {\Huge\color{red}\bf WORK IN PROGRESS}
...
laws of planetary motion using L3 calculus and the theory of conics.
    ...
    \item Kepler's first law.
      \begin{enumerate}
        ...
        \item Further, show that
              ...
              \end{displaymath}
        \item Write $ e = Bh^2/GM $ in the equation of (e), and conclude \df{Kepler's second law} by comparison
              with exercise 1P: the locus of $ P $ is a conic section with one focus $ O $.\footnote{It can be shown
