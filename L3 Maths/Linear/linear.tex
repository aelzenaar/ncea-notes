...
\begin{ex}\leavevmode
  \begin{center}
    \itshape\parbox{0.8\textwidth}{
      A group of students decide to start a roadside stall selling small bracelets and stuffed animals. They
      put all their money together and have a starting capital of \$1610. They have already received an order
      for twenty stuffed animals; it costs \$2 to produce bracelet, and \$5 to produce a stuffed animal. What
      possible starting inventories do the students have?
    }
  \end{center}
  ...
  \begin{equation}
    ...
    \end{cases}
  \end{equation}
  (where $ x $ represents the initial inventory of bracelets, and $ y $ the inventory of stuffed animals.)
...
\begin{enumerate}
  \item Write down the linear constraints corresponding to the following situations, and graph the feasible regions.
    \begin{enumerate}
      ...
      \item Fuel from petrol pump A costs \$2.19 per litre and from petrol pump B costs \$1.69 per litre. Georgia has at most \$20 to spend on fuel.
    ...
    \end{enumerate}
  \item During a family trip, Jacob shared the driving with his mother. At most, he was allowed to drive for three hours in total. While driving, his
