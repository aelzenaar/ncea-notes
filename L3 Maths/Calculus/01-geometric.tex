...
\goals{To remember why we care about derivatives, and remind ourselves of how slopes should behave.}
  ...
  \begin{center}
    \fbox{\begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[domain = -5:5, color = red] {x^2 - 2*x + 1};
      \end{axis}
    \end{tikzpicture}}
  \end{center}
  ...
  \begin{center}
    \fbox{\begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[domain = -5:5, color = blue] {2*(x-1)};
      \end{axis}
    \end{tikzpicture}}
  \end{center}
  \end{multicols}
...
\begin{questions}%\item
  ...
  \questioM The number of bacteria after $ t $ hours in a controlled laboratory experiment is $ n = f(t) $.
    \begin{parts}
      \part What is the meaning of the derivative $ f'(5) $?
