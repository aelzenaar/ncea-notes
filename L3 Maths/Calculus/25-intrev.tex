...
\begin{questions}
  ...
  \fullwidth{(Note on the above two questions: the problem of finding a function $ q(t) $ such that the integral of some expression
  involving $ q(t) $ and its derivative is minimised over a given interval is a fundamental problem in physics, surprisingly!)}
