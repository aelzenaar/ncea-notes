 ...
 * [Elementary texts: stage I and II](#elementary-texts--stage-i-and-ii)
   ...
   + [Multi-variable calculus (253, 340)](#multi-variable-calculus--253--340-)
   + [Linear algebra (130, 250, 253)](#linear-algebra--130--250--253-)
   + [Discrete/computational mathematics (162)](#discrete-computational-mathematics--162-)
   + [Logic, "proofs", and naive set theory (255)](#logic---proofs---and-naive-set-theory--255-)
   + [Elementary number theory (255)](#elementary-number-theory--255-)
   + [Differential Equations (260)](#differential-equations--260-)
 * [Upper-level undergraduate texts: Stage III](#upper-level-undergraduate-texts--stage-iii)
   ...
   + [Single-variable analysis (332)](#single-variable-analysis--332-)
   + [Topology](#topology)
   + [Multi-variable analysis (333)](#multi-variable-analysis--333-)
...
### Single-variable calculus (130, 250)
 ...
 * Michael Spivak, _Calculus_. Do I really need to say any more? Indeed, this book is more of an introductory real analysis book than a 'standard' calculus
   ...
   Highlights include a very readable motivation for completeness of the reals and 𝜀-𝛿 proofs; most exercises are also very interesting. I would avoid the
 ...
 * Paul Halmos, _Finite-Dimensional Vector Spaces_. My favourite linear algebra book! This book covers the same content as 253 but in much greater
   detail. Like every other Paul Halmos book, it is incredibly well-written; just take care not to get bogged down by the sections on multi-linear
 ...
 * Nathan Carter, _Visual Group Theory_. This book is worth finding in the library for the pictures, which simply do not exist in most other books. However,
   the actual development of the theory is done much better in other books. (512.2 C325)
 * Joseph Gallian, _Contemporary Abstract Algebra_. This is the book that 320 is based on. Lots of computational exercises. Some "topic" readings at the back
...
### Number theory
 * Gareth A. Jones and J. Mary Jones, _Elementary Number Theory_. This is a step up from Dudley (see above). There are some very interesting
