...
\begin{questions}
  ...
  \question Challenge problem 1. Let $ ABCD $ be a parallelogram. Draw a square on each side of the parallelogram, and choose
    ...
    \begin{parts}
      \part (Napoleon's theorem) Show that these centres form the vertices of a larger square.
      \part Show that the diagonals of this square intersect at the same point as the diagonals of $ ABCD $.
    \end{parts}
